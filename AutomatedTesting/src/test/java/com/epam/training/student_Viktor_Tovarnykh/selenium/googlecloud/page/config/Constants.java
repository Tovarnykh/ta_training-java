package com.epam.training.student_Viktor_Tovarnykh.selenium.googlecloud.page.config;

public class Constants {

    public static final String LOADING_TEXT_SELECTOR = "//div[contains(text(),'Calculating changes')]";
